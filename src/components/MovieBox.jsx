...
function MovieBox({ title, releaseDate, openCrawl, handleMouseOver }) {
  return (
    <div
      className="movie-box w-[100%] p-[2rem] my-[2rem] bg-gray-500 bg-boxBg  bg-blend-multiply sm:min-w-[48%] sm:max-w-[48%] lg:min-w-[32%] lg:max-w-[32%] hover:shadow-[0px_0px_6px_4px_rgba(111,151,222,1)]"
